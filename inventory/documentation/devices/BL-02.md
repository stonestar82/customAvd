...
| --------- | --------------- | ------------ | --------- |
| DC1_BL | Vlan4094 | 192.168.0.8 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | MLAG_PEER_BL-01_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet8 | MLAG_PEER_BL-01_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to Spine-01-Ethernet6 | routed | - | 100.100.0.21/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to Spine-02-Ethernet6 | routed | - | 100.100.0.23/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_PEER_BL-01_Po1000 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_PEER_BL-01_Po1000
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | RouterID_EVPN | default | 1.1.1.6/32 |
...
| 100.100.0.20 | 65000 | default | - | Inherited from peer group UNDERLAY | Inherited from peer group UNDERLAY | - | - | - |
| 100.100.0.22 | 65000 | default | - | Inherited from peer group UNDERLAY | Inherited from peer group UNDERLAY | - | - | - |
...
router bgp 65005
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description BL-01
   ...
   neighbor 10.255.251.8 description BL-01
   neighbor 100.100.0.20 peer group UNDERLAY
   neighbor 100.100.0.20 remote-as 65000
   neighbor 100.100.0.20 description Spine-01
   neighbor 100.100.0.22 peer group UNDERLAY
   neighbor 100.100.0.22 remote-as 65000
   neighbor 100.100.0.22 description Spine-02
